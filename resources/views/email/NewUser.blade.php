                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <td>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <h2 align="center">You have New User Signup on Ingenium</h2>
                                                                            <br>
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text es-p20t" align="center">
                                                                    <h3 style="color: #333333;">Thank you, Ingenium Concept</h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="esd-block-text es-m-txt-c es-p5b" esdev-links-color="#777777" align="left">
                                                                                    <p style="color: #777777;"> © 2022
                                                                                        Ingenium Concept <br> You are receiving
                                                                                        this email because you signed up
                                                                                        on <a href="growwithingenium.com" style="color:#aaaaaa">Ingenium Concept</a>. .<br></p>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
