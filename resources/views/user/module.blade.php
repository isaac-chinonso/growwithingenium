@extends('layout.apps')
@section('title')
Class Module || Ingenium Concept LTD
@endsection
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Class Modules</h4>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-sm" style="background-color: #B78700;color:#fff;"><a href="{{ route('viewlesson', $mod->id) }}" class="text-white">See Module Lessons</a></button></td>
                                    </tr>
                                    <?php $number++; ?>
                                    @endforeach
