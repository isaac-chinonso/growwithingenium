...
<body>
    <div class="main-page-wrapper">
            ...
            <svg height="0 " width="0 ">
                <defs>
                    <clipPath id="shape-one ">
                        <path fill-rule="evenodd " fill="rgb(168, 168, 168) " d="M343.000,25.000 C343.000,25.000 100.467,106.465 25.948,237.034 C-30.603,336.119 15.124,465.228 74.674,495.331 C134.224,525.434 212.210,447.071 227.280,432.549 C242.349,418.028 338.889,359.517 460.676,506.542 C582.737,653.896 725.650,527.546
                                    751.000,478.000 C789.282,403.178 862.636,-118.314 343.000,25.000 Z " />
                    </clipPath>
                </defs>
            </svg>
        </div>
        ...
        <!-- Vendor js _________ -->
        <!-- Video Background -->
        <script type="text/javascript" src="asset/vendor/Vide-master/jquery.vide.js"></script>
        <!-- Camera Slider -->
